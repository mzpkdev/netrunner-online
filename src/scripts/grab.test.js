...
describe('grabCard', () => {
    ...
    describe('left-click (button 0)', () => {
        it('dispatches a grab CustomEvent with targetX and targetY from getBoundingClientRect', () => {
            ...
            grabHandler(new MouseEvent('mousedown', { button: 0, clientX: 50, clientY: 80, bubbles: true }))
    ...
    describe('mousemove after grab', () => {
        beforeEach(() => {
            ...
            grabCard(element)(new MouseEvent('mousedown', { button: 0, clientX: 50, clientY: 80, bubbles: true }))
        })
        ...
        it('dispatches a move CustomEvent with coordinates matching clientX + offsetX', () => {
            ...
            document.body.dispatchEvent(new MouseEvent('mousemove', { clientX: 60, clientY: 90, bubbles: true }))
    ...
    describe('mouseup after grab', () => {
        ...
        it('removes the mousemove listener from body so subsequent moves do not dispatch move events', () => {
            ...
            let moveCount = 0
            element.addEventListener('move', () => { moveCount++ })
        ...
        it('removes the mouseup listener from body so a subsequent mouseup does not dispatch ungrab again', () => {
            ...
            let ungrabCount = 0
            element.addEventListener('ungrab', () => { ungrabCount++ })
            document.body.dispatchEvent(new MouseEvent('mouseup', { bubbles: true }))
    ...
    describe('non-left-click (button !== 0)', () => {
        it('does not dispatch a grab CustomEvent', () => {
            ...
            element.addEventListener('grab', () => { eventFired = true })

            grabHandler(new MouseEvent('mousedown', { button: 2, clientX: 50, clientY: 80, bubbles: true }))
